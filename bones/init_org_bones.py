...
def restore_bone_visibility (hidden_def_bones):
  for hidden_def_bone in hidden_def_bones:
    hidden_def_bone.hide = True
      
def init_org_bones ():
  hidden_def_bones, selected_bones = select_def_bones()
  duplicate_bones()
  rename_org_bones(selected_bones)
  restore_bone_visibility(hidden_def_bones)
  deselect_bones()
